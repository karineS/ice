...
// <auto-generated>
//
// Generated from file `_ForumDelD.java'
//
...
public final class _ForumDelD extends Ice._ObjectDelD implements _ForumDel
{
    public void
    getInfo(final Ice.StringHolder theme, final Ice.StringHolder moderator, final Ice.LongHolder size, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    Forum __servant = null;
                    try
                    {
                        __servant = (Forum)__obj;
                    }
                    catch(ClassCastException __ex)
                    {
                        throw new Ice.OperationNotExistException(__current.id, __current.facet, __current.operation);
                    }
                    __servant.getInfo(theme, moderator, size, __current);
    ...
    {
        final Ice.Current __current = new Ice.Current();
        __initCurrent(__current, "getMessages", Ice.OperationMode.Normal, __ctx);
        final MessageSetHolder __result = new MessageSetHolder();
        IceInternal.Direct __direct = null;
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                public Ice.DispatchStatus run(Ice.Object __obj)
                {
                    ...
                    __result.value = __servant.getMessages(__current);
                    return Ice.DispatchStatus.DispatchOK;
                }
            };
            try
    ...
    {
        final Ice.Current __current = new Ice.Current();
        __initCurrent(__current, "getModerator", Ice.OperationMode.Normal, __ctx);
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                public Ice.DispatchStatus run(Ice.Object __obj)
                {
                    ...
                    __result.value = __servant.getModerator(__current);
                    return Ice.DispatchStatus.DispatchOK;
                }
            };
            try
    ...
    {
        final Ice.Current __current = new Ice.Current();
        __initCurrent(__current, "getTheme", Ice.OperationMode.Normal, __ctx);
        final Ice.StringHolder __result = new Ice.StringHolder();
        IceInternal.Direct __direct = null;
        try
        {
